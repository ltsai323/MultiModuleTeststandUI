...
sudo docker run --device=/dev/ttyUSB0 --name pymodule-usbrs232-powersupply -p 2235:2000 pymodule-usbrs232-powersupply python server.py device:ASRL/dev/ttypUSB0::INTSR
