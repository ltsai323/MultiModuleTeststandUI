...
def execute_job_from_queue():
    ...
    while True:
        if job_queue.empty():
            ...
            ''' to do list
            1. for N channel, update message after N socket channel collected informations
            2. Check job queue, if no job, add MONITOR for checking
            3. Update message after all information updated.
            '''
